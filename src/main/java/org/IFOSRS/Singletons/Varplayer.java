...
/*
* Essentially Varps are the full data bytes containing all the settings
* Varbits are isolated values extracted from the Varps
* */

public interface Varplayer extends ClientWrapper
{
     ...
     * Mapping of value to name can be found in
     */
    public static final int SLAYER_TASK_CREATURE = 395;

    /**
     * Assigned slayer task location. The mapping of value to name can be found in
     */
